...
class EditEventsSponsors extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        $data["first_name_ar"] = $data['first_name']['ar'];
        $data["first_name_en"] = $data['first_name']['en'];
        $data["last_name_ar"] = $data['last_name']['ar'];
        $data["last_name_en"] = $data['last_name']['en'];
        $data["job_position_ar"] = $data['job_position']['ar'];
        $data["job_position_en"] = $data['job_position']['en'];
        return $data;
    }
