...
class EventsSponsorsAddNewRequest extends FormRequest
{
    /**
    ...
    {
        $this->merge([
            "code" => EventsSponsorsServices::GenerateNewCode(),
    ...
    public function rules(): array
    {
        ...
        return [
            'code' => "required|unique:events_sponsors,code",
            ...
            'email' => "required|email|unique:events_sponsors,email",
